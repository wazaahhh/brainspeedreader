...
\title{Controlling Speed Reading with Brainwaves\titlenote{(Produces the permission block, and
...
% 1st. author
\alignauthor
Thomas Maillart\titlenote{Corresponding author.}\\
       %\affaddr{UC Berkeley}\\
       %\affaddr{102 South Hall Road}\\
       %\affaddr{Berkeley, USA}\\
...
\bibliography{../bib/rsvp.bib,../bib/tmaillart.bib}
\end{document}
